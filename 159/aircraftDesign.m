...
syms k
if engineCount == 2
    syms1 = TOFL/1000 == 1.22151E-05*k^2 + 3.05003E-02*k + 7.20664E-01;
elseif engineCount == 3
    syms1 = TOFL/1000 == 1.01866E-05*k^2 + 2.73987E-02*k + 6.32114E-01;
elseif engineCount == 4
    syms1 = TOFL/1000 == 1.02991E-05*k^2 + 2.61212E-02*k + 3.98793E-01;
end

Kw = vpasolve(syms1, k);
Kw = double(Kw(real(Kw)>0));
...
WT = WT_Vlo * T_m(Mlo7)/T_SLS; %thrust loading 
...
% plot(W_TO,y)
f1 = wA*WTO.^1.195 + wB*WTO.^0.235 + wC*WTO + wD == 0;
WT_O = double(vpasolve(f1,WTO,[0,1000000]));
%sizing
...
fprintf('AR: %i   Sweep Angle: %i   Wing Engines: %i   Fuselage Engines: %i   EngineType: %s   Fuel Consumed: %.2f\n\n', AR, sweep, wingEngines, fuselageEngines, engineType, X)
