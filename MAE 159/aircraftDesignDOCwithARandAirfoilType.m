...
title('Direct Operating Costs with Airfoil Type and Airframe Materials')
legend('Conventional - Aluminum','Supercritical - Aluminum','Conventional - Composite','Supercritical - Composite','Conventional - Hybrid','Supercritical - Hybrid')
%print out
