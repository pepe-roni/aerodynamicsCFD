...
for i=1:7
    ...
    title('Direct Operating Costs with AR and Sweep - Composite')
    subplot(1,2,2)
     hold on
    plot(ARarr, WTOarray)
    xlabel('Aspect Ratio')
...
title('Takeoff Weight with AR and Sweep - Composite')
legend('Sweep 25','Sweep 27.5','Sweep 30', 'Sweep 32.5', 'Sweep 35', 'Sweep 37.5', 'Sweep 40')
%print out
