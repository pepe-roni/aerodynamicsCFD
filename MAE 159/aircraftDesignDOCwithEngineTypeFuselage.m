...
for i=1:6
    for j=1:3
        ...
        DOCarray(j) =  WT_O;
        ARarr(j) = fuselageEngines;
        fuselageEngines = fuselageEngines + 1;
    end
    hold on
    figure(1)
    plot(ARarr, DOCarray)
    xlabel('Number of Fuselage Engines')
...
xticks([2,3,4])
title('Direct Operating Costs with Airframe Materials, Fuselage Engine Type and Count')
legend('JT9D Advanced - Aluminum','JT9D Standard - Aluminum','JT9D Advanced - Composite','JT9D Standard - Composite','JT9D Advanced - Hybrid','JT9D Standard - Hybrid')
%print out
